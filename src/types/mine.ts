...
export type UpdateTileRevealTypeReturn = {
    ok: true;
    type: RevealType;
};
...
export type GetTileRevealType = () => RevealType;
export type UpdateTileRevealType = () => UpdateTileRevealTypeReturn;
export type UpdateFlagType = () => UpdateFlagTypeReturn;

export type SurroundTilesIndex = {
    right: number | null;
    left: number | null;
    top: number | null;
    bottom: number | null;
...
/** @description 單一格子的座標 */
export type SingleMineTileAxis = {
    /** @description 座標 x (from 0) */
    x: number;
    /** @description 座標 y (from 0) */
    y: number;
    /** @description 附近格子的 index (from 0) */
    surroundTilesIndex: SurroundTilesIndex;
};

export type SingleMineTile = {
    axis: SingleMineTileAxis;
    ...
    getTileRevealType: GetTileRevealType;
    /** @description 揭露此格（更新 revealType) */
    updateTileRevealType: UpdateTileRevealType;
